          ...
          <div className="flex flex-col justify-center h-full md:shrink-0">
                ...
                <button
                  ...
                  className={`${
                    isLoading
                      ...
                      : ''
                  } inline-block w-full rounded-md bg-[#116CEF] hover:bg-[#FFE600] hover:text-[#00235C] px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out`}
                >
                  Ingresa
                </button>
            ...
            <section className="logos flex justify-between items-center md:shrink-0 mx-14 md:mx-12 lg:mx-28">
              ...
              <div className="flex items-center nowrap">
                <img
                  className="h-10 w-18 md:h-12 md:w-20 lg:h-10 lg:w-18 "
                  src={logoInnovacion}
                  alt=""
                />
