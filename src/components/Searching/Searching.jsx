  ...
  return (
    <div className='container mt-12 flex flex-col justify-center items-center'>
      <Link to='/'>
        <button
          type='button'
          className='btn_back_searching text-secondary text-sm px-5 py-2.5 text-center inline-flex items-center'
        >
          <FontAwesomeIcon icon={faChevronLeft} className='mr-2' />
          Volver
        </button>
      </Link>
      <h1 className='mb-4 text-center'>¿Qué noticias vamos a encontrar hoy?</h1>
