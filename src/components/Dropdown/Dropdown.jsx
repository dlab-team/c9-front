...
const Dropdown = ({ isAdmin }) => {
    ...
    return ( 
        <div className="relative flex items-center">  
            ...
            <div 
                id="dropdownMenu" 
                className={`absolute z-50 ${isOpen ? '' : 'hidden'} bg-white divide-y divide-gray-200 rounded-lg shadow-lg w-44`}
                style={{
                    top: '100%',
                    left: '50%', 
            ...
            >
                ...
                <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownUserAvatarButton">
                    <li>
                        <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Mi Perfil</a>
                    </li>
                    <li>
                        <Link 
