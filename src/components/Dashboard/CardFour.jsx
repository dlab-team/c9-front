...
const CardFour = () => {
    ...
    return (
        <div className="rounded-md border border-gray-50 text-center bg-white py-6 shadow-xl">
            <div className="flex h-11 w-11 items-center mx-auto justify-center rounded-full bg-gray-100">
            <svg
            ...
            <div>
                ...
                <span className="text-sm font-light text-gray-600">Total de usuarios</span>
            </div>
            </div>
        </div>
    );
